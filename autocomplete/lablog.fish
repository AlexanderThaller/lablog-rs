...
complete -c lablog -n "__fish_using_command lablog note" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog note" -s V -l version -d "Prints version information"
complete -c lablog -n "__fish_using_command lablog notes" -s B -l before -d "filter all notes that lay before the given date"
complete -c lablog -n "__fish_using_command lablog notes" -s A -l after -d "filter all notes that lay after the given date"
...
complete -c lablog -n "__fish_using_command lablog web" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog web" -s V -l version -d "Prints version information"
complete -c lablog -n "__fish_using_command lablog dates" -s B -l before -d "filter all notes that lay before the given date"
complete -c lablog -n "__fish_using_command lablog dates" -s A -l after -d "filter all notes that lay after the given date"
...
complete -c lablog -n "__fish_using_command lablog dates" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog dates" -s V -l version -d "Prints version information"
complete -c lablog -n "__fish_using_command lablog timeline" -s B -l before -d "filter all notes that lay before the given date"
complete -c lablog -n "__fish_using_command lablog timeline" -s A -l after -d "filter all notes that lay after the given date"
...
complete -c lablog -n "__fish_using_command lablog search" -s B -l before -d "filter all notes that lay before the given date"
complete -c lablog -n "__fish_using_command lablog search" -s A -l after -d "filter all notes that lay after the given date"
