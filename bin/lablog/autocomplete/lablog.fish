...
complete -c lablog -n "__fish_using_command lablog" -f -a "edit"
...
complete -c lablog -n "__fish_using_command lablog archive" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog archive" -s V -l version -d "Prints version information"
complete -c lablog -n "__fish_using_command lablog edit" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog edit" -s V -l version -d "Prints version information"
complete -c lablog -n "__fish_using_command lablog edit" -s h -l help -d "Prints help information"
complete -c lablog -n "__fish_using_command lablog edit" -s V -l version -d "Prints version information"
